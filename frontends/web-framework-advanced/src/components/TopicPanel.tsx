    ...
    return (
      <main className="main-panel">
        <div className="empty-state">
          ...
          <div className="empty-title">Express Advanced Playground</div>
          <div className="empty-subtitle">
            Select a topic from the sidebar to start exploring the advanced Express concepts interactively.
          </div>
        </div>
      </main>
    )
